...
const slot6 = new Slot(TABLEX + CARDSPACE * 5, TABLEY);
...
const opslot6 = new Slot(OPX + CARDSPACE * 5, OPY);
const slots = [slot1,slot2,slot3,slot4,slot5,slot6, opslot1, opslot2, opslot3, opslot4, opslot5, opslot6];
...
function draw() {
    background(220);
    scoreBoard.draw();
    for(let slot of slots)slot.draw();
